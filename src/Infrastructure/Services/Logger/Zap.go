...
func newZapLogger(config domainlogger.LoggerConfiguration) (domainlogger.Logger, error) {
	cores := []zapcore.Core{}
...
func (l *zapLogger) WithFields(fields domainlogger.Fields) domainlogger.Logger {
